...
public class JSONRetriever {
	/**
	 * L'objet à "réveiller" une fois le chargement terminé. Dans la plupart des
	 * cas, il s'agira d'une activité implémentant CallbackObject.
	 */
	 ...
	 *            l'object CallbackObject à appeler à la fin de l'opération
	 * @return (via la méthode callback du paramètre callbackObject) le
	 *         JSONObject récupéré
	 */
	 ...
	 * 
	 * @see http
	 *      ://p-xr.com/android-tutorial-how-to-parse-read-json-data-into-a-android
	 *      -listview/
	 * @author Androidpxr | p-xr.com
	 * @param url
	 *            url source au format String
	...
	/**
	 * Routine de téléchargement d'un JSONArray. L'url et l'objet sur lequel
	 * effectuer le callback doivent être spécifiés.
	 */
	...
	/**
	 * Routine de téléchargement d'un JSONObject. L'url et l'objet sur lequel
	 * effectuer le callback doivent être spécifiés.
	 */
